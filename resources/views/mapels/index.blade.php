 ...
 <section role="main" class="content-body">
    ...
    <section class="card mt-3">
        ...
        <div class="card-body">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#createMapel">Tambah Data Mapel</button>
            <a href="{{ route('mapel.print') }}">
                <button class="btn btn-primary">Cetak Data Mapel</button>
            </a>
        ...
        @csrf
          <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="kode_mapel" id="kode">
              </div>
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Mata Pelajaran:</label>
                <input type="text" class="form-control" name="nama_mapel" id="mapel">
              </div>
              <div class="form-group">
