            ...
            <form method="post" action="{{ route('kelas.store') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="kode_kelas" maxlength="5">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Tingkat <span class="required">*</span></label>
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="tingkat" maxlength="4" placeholder="Contoh : X/XI/XII/XIII">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label class="col-md-3 control-label">Jurusan <span class="required">*</span></label>
                            <div class="col-md-7">
                                <select data-plugin-selectTwo name="id_jurusan"  id="jurusan">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select data-plugin-selectTwo name="id_tahun"  id="tahun">
