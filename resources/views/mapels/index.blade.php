...
<section role="main" class="content-body">
   ...
   <section class="card mt-3">
      ...
      <div class="card-body">    
         <button class="btn btn-primary" data-toggle="modal" data-target="#createMapel"><i class="fa fa-plus"></i></button>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td style="text-align: center;">
                     <button class="btn btn-primary col-sm-4" data-toggle="modal" data-target="#editMapel" data-id="{{ $data->id_mapel }}" data-kode="{{ $data->kode_mapel }}" data-nama="{{ $data->nama_mapel }}" data-jurusan="{{ $data->jurusan->nama_jurusan }}" data-kategori="{{ $data->kategori}}"><i class="fa fa-pencil-alt"></i></button>
