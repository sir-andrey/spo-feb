 ...
 <section role="main" class="content-body">
   ...
   <section class="card mt-3">
      ...
      <div class="card-body">
         ...
         <button class="btn btn-primary" data-toggle="modal" data-target="#createTahun"><i class="fa fa-plus"></i></button>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td style="text-align: center;">
                      <button class="btn btn-primary" data-toggle="modal" data-target="#editTahun" data-id="{{ $tahun->id_tahun }}" data-kode="{{ $tahun->kode_tahun }}" data-tahun="{{ $tahun->tahun }}"><i class="fa fa-pencil-alt"></i></button>
                      <a href="{{ route('tahun.destroy', $tahun->id_tahun) }}">
                          <button class="btn btn-danger col-sm-4" onclick="return confirm('Hapus data ini?')">Hapus</button>
                       </a></td>
               </tr>
               @endforeach
            </tbody>
