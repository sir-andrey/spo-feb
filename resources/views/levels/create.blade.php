...
@section('content')
 ...
 <section role="main" class="content-body">
      ...
      <ol class="breadcrumb mt-3">
        ...
        <li class="breadcrumb-item"><a href="{{ route('level.index') }}">Data Level</a></li>
            ...
            <form method="post" action="{{ route('level.store') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Kode Level<span class="required">*</span></label>
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="kode_level" maxlength="5">
                            </div>
                        </div>
                        <div class="form-group">
